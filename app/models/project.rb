class Project < ApplicationRecord
  ...
  has_many :document_projects, dependent: :destroy
  has_many :documents, :through => :document_projects
  has_many :feedbacks
  # has_one :project_manager, class_name: 'User', foreign_key: :managed_project_id
  has_many :project_manager_projects, -> {ProjectManagerProject.where(project_manager_id: ProjectManager.all.pluck(:id))}, dependent: :destroy
