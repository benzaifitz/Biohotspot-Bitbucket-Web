ActiveAdmin.register ProjectManager, as: 'Project Manager', namespace: :pm  do
  ...
  form do |f|
    f.inputs 'Project Manager Details' do
      ...
      # f.input :project
      # f.input :projects, multiple: true
...
=end
  ...
  controller do
    def update
      super do |format|
        redirect_to pm_users_path, :notice => 'Project Manager updated successfully.' and return if resource.valid?
      end
    end
    ...
    def create
      super do |format|
        if resource.valid?
          ...
          redirect_to pm_users_path, :notice => 'Project Manager created successfully.' and return
        end
      end
    end
  end
